...
const StudentSubmissions = () => {
  ...
  const [form, setForm] = useState({ title: "", file: null, project: "" });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token =
        localStorage.getItem("access") || sessionStorage.getItem("access");
      await submitSubmission(form, token);
      setSuccess("Submission uploaded successfully!");
      setForm({ title: "", file: null, project: "" });
      fetchSubmissions();
    } catch (err) {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <div className="bg-white rounded shadow p-4 mb-8">
        <h3 className="text-lg font-semibold mb-2">Upload New Submission</h3>
